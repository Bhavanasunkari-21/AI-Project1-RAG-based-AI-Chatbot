...
<p align="center">
  <img src="demo.gif" alt="App Demo" width="700"/>
</p>
...
Most AI chat tools — including ChatGPT with file uploads — let you upload one document at a time and ask questions about it. This system is built specifically for working across a library of documents simultaneously.

| Scenario | Regular chatbot | This system |
|---|---|---|
| Compare two resumes against a job spec | Upload one at a time, ask three separate questions, manually compare | Upload all three at once, ask once, get a single synthesised comparison |
...
**Recruitment**
Upload 5 candidate resumes and 1 job description. Ask: "Rank these candidates by fit and explain the gaps for each." The system reads all six files and returns a ranked comparison in one response, citing which resume page each assessment came from.

**Legal and compliance**
Upload a supplier contract, your internal procurement policy, and the relevant regulation. Ask: "Where does this contract conflict with our policy or the regulation?" The system finds the relevant clause from each document and surfaces the conflict directly.
...
**Employee onboarding**
Upload HR handbook, role-specific guide, org chart, and benefits document. Ask: "What is the process for requesting leave and who do I report to?" One answer drawn from multiple internal documents.
